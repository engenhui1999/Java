  ...
  */
  ...
  public static String getGrade(String student, String module, String assessment,
    ...
    Transformer<Map<String, Map<String, String>>, Maybe<Map<String, String>>> getModule = new Transformer<>() {
      public Maybe<Map<String, String>> transform(Map<String, Map<String, String>> map1) {
        return Maybe.<Map<String, String>>of(map1.get(module));
      }
    };

    Transformer<Map<String, String>, Maybe<String>> getAssessment = new Transformer<>() {
      public Maybe<String> transform(Map<String, String> map2) {
        return Maybe.<String>of(map2.get(assessment));
      }
    };
    return Maybe.<Map<String, Map<String, String>>>of(map.get(student)).flatMap(getModule).flatMap(getAssessment).orElse("No such entry");
  }
